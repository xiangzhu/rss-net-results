...
Prioritization results are summarized by the following two tables,
...
(specified by **Chr.**, **Start** and **End** columns)
...
**Baseline P1** and **Enrichment P1** are obtained from fitting
RSS-NET baseline and enrichment models respetively.
